...
public class InventoryGoodsReceiveNoteRestController {
	...
	public ResponseEntity<JsonResponse<Object>> saveBatchDetails(@RequestBody List<BatchModel> batch) {
	...
	public ResponseEntity<JsonResponse<List<InventoryCustomerMailModel>>> getDetailsForMail(@RequestParam String id) {
	...
	public ResponseEntity<JsonResponse<List<BatchModel>>> editViewBatchDetails(@RequestBody BatchModel id) {
	...
	public List<DropDownModel> getSequenceNumber(@RequestParam String id, @RequestParam String grn,
	...
	@RequestMapping(value = "saveInspectDetails", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<Object>> saveInspectDetails(@RequestBody List<InspectGoodsReceiveModel> batch) {
		logger.info("Method : saveBatchDetails starts");
		logger.info("Method : invGoodsResaveBatchDetailsceive ends");
		return inventoryGoodsReceiveNoteDao.saveInspectDetails(batch);
	}

	/*
	 * 
	 * Get mapping for get Sub inventory by Store
	 * 
	 * 
	 */
	@GetMapping(value = "getSubInventoryByStore")
	public List<DropDownModel> getSubInventoryByStore(@RequestParam String id) {
		logger.info("Method : getSubInventoryByStore starts");
		logger.info("Method : getSubInventoryByStore endss");
		return inventoryGoodsReceiveNoteDao.getSubInventoryByStore(id);
	}
	 ...
	 * 
	 */
	@PostMapping(value = "getSubInventoryByStorePost")
	public List<DropDownModel> getSubInventoryByStorePost(@RequestBody List<DropDownModel> itemList) {
		logger.info("Method : getSubInventoryByStorePost starts");
		logger.info("Method : getSubInventoryByStorePost endss");
		return inventoryGoodsReceiveNoteDao.getSubInventoryByStorePost(itemList);
	}
	/*
	 * 
	 * Get mapping for get Sub inventory by Store
	 ...
	 * 
	 */
	@PostMapping(value = "rest-get-ware-house-post")
	public List<DropDownModel> getStorePost(@RequestBody List<DropDownModel> itemList) {
		logger.info("Method : getStorePost starts");
		logger.info("Method : getStorePost endss");
		return inventoryGoodsReceiveNoteDao.getWareHousePost(itemList);
	}
	
	
	/*
	 * 
	 * Get mapping for get rack details
	 * 
	 * 
	 */

	@RequestMapping(value = "/get-shelfs-list", method = { RequestMethod.GET })
	public ResponseEntity<JsonResponse<List<AllocateItemsToRackModel>>> getShelfsList(@RequestParam String id,
			@RequestParam String itemId) {
		logger.info("Method : getShelfsList starts");

		logger.info("Method : getShelfsList endss");
		return inventoryGoodsReceiveNoteDao.getShelfsList(id, itemId);
	}
	...
	@RequestMapping(value = "/get-ware-house", method = { RequestMethod.GET })
	public ResponseEntity<JsonResponse<List<DropDownModel>>> getWareHouseList(@RequestParam String id) {
		logger.info("Method : getWareHouseList starts");

		logger.info("Method : getWareHouseList endss");
		return inventoryGoodsReceiveNoteDao.getWareHouseList(id);
	}

	/*
	 * 
	 * PostMapping for add rest inspected details
	 * 
	 * 
	 */
	@RequestMapping(value = "rest-adds-allocated-shelfs", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<Object>> saveAllocateDetails(
			@RequestBody List<AllocateItemsToRackModel> invGoodsReceiveModel) {
		logger.info("Method : saveAllocateDetails starts");
		logger.info("Method : saveAllocateDetails ends");
		return inventoryGoodsReceiveNoteDao.saveAllocateDetails(invGoodsReceiveModel);
	}
	 ...
	 * 
	 */
	@RequestMapping(value = "rest-adds-barcode-details", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<Object>> saveBarcodeDetails(
			@RequestBody List<AllocateItemsToRackModel> dataList) {
		logger.info("Method : saveBarcodeDetails starts");
		logger.info("Method : saveBarcodeDetails ends");
		return inventoryGoodsReceiveNoteDao.saveBarcodeDetails(dataList);
	}
	 ...
	 * 
	 */
	@RequestMapping(value = "rest-get-barcode-details", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<List<DropDownModel>>> getBarcodeDetails(
			@RequestBody List<AllocateItemsToRackModel> dataList) {
		logger.info("Method : saveBarcodeDetails starts");
		logger.info("Method : saveBarcodeDetails ends");
		return inventoryGoodsReceiveNoteDao.getBarcodeDetails(dataList);
	}
}