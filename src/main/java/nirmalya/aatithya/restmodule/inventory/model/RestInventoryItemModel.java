...
public class RestInventoryItemModel {
	...
	public RestInventoryItemModel(Object item, Object tAccountGroupType, Object tPurchaseSubGroup,
			...
			Object productionTypeId, Object itemImg, Object itemQty, Object price, Object salesPrice, Object hsnCode,
			Object purchaseTAX, Object purchaseCess, Object saleTAX, Object saleCess, Object purchaseName,
			Object saleName)

	{
		...
		try {
			this.purchaseName = (String) purchaseName;
		} catch (Exception ex) {
			ex.printStackTrace();
		}
		try {
