			...
			if (!x.isEmpty()) {
				for (Object[] m : x) {
					...
					RestInventoryGoodsReceiveModel itmCat = new RestInventoryGoodsReceiveModel(m[0], m[1], null, m[2],
							...
							null, m[5], approveStageNo, m[7], approveLevelNo, m[9], null, null, null, null,null,null,m[10],null);
		...
		try {
			...
			for (Object[] m : x) {
				...
				RestInventoryGoodsReceiveModel invGoodsReceiveModel = new RestInventoryGoodsReceiveModel(m[0], m[1],
						...
						m[26], m[27], m[28], m[29], null, null, null, null, null, m[30], m[31], m[32],m[33],m[34],null,m[35],m[36]);
		...
		try {
			...
			for (Object[] m : x) {
				RestInventoryGoodsReceiveModel restItemModel = new RestInventoryGoodsReceiveModel(m[0], m[1], null,
						...
						m[20], m[21], null, null, null, null, null, m[22], m[23], null,m[24],m[25],null,null,m[26],null);
	...
	public ResponseEntity<JsonResponse<Object>> saveBatchDetails(
		...
		if (validation) {
			...
			try {
				...
				em.createNamedStoredProcedureQuery("goodsReceiveInvoiceRoutines")
						.setParameter("actionType", "saveBatchDtls").setParameter("actionValue", value)
						.execute();
		...
		try {
			...
			for (Object[] m : x) {
				...
				RestInventoryGoodsReceiveModel restItemModel = new RestInventoryGoodsReceiveModel(m[0], m[1], grnDate,
						...
						m[22], m[23], null, null, null, null, null, null, m[24], null, null, null,null,null,null,null);
...
//						  m[2], m[3] , m[4], m[5], m[6]); 
	...
	public ResponseEntity<JsonResponse<List<BatchModel>>> editViewBatchDetails(BatchModel id) {
		...
		try {
			...
			for (Object[] m : x) {
				BatchModel dropDownModel = new BatchModel(m[0], m[1], m[2], m[3], m[4],
						null, m[5], null);
