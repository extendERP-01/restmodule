...
public class AssignVehicleToDriverRestController {
	...
	@RequestMapping(value="restLogoImage-Driver" , method={RequestMethod.GET})
	public List<DropDownModel> restHotelLogoImage(@RequestParam("logoType") String logoType) {
		...
		return assignVehcicleToDriverDao.getHotelLogoImage(logoType);
	}
	
	@RequestMapping(value = "getVehicleDriverReportForPreview", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<List<AssignVehicleToDriverModel>>> getVehicleDriverReportForPreview(
			@RequestBody DataTableRequest request) {
		...
		return assignVehcicleToDriverDao.getVehicleDriverReportForPreview(request);
	}
	
	@RequestMapping(value = "getVehicleDriverReportPdf", method = { RequestMethod.POST })
	public ResponseEntity<JsonResponse<List<AssignVehicleToDriverModel>>> getVehicleDriverReportPdf(
			@RequestBody DataTableRequest request) {
		...
		return assignVehcicleToDriverDao.getVehicleDriverReportPdf(request);
	}
}
