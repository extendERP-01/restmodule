...
public class ContraVoucherRestController {
	...
	/*
	 * 
	 * Get mapping for get Debit Account Group by auto search
	 * 
	 * 
	 */
	
	@RequestMapping(value = "/getAccountGroupForContra", method = { RequestMethod.GET })
	public ResponseEntity<JsonResponse<List<AccountJournalVoucherModel>>> getinvsubGroupPayment(@RequestParam String id) {
		...
		return contraVoucherDao.getAccountGroupForContra(id);
	}
